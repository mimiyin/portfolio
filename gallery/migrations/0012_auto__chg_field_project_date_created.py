...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.date_created'
        db.alter_column(u'gallery_project', 'date_created', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Project.date_created'
        db.alter_column(u'gallery_project', 'date_created', self.gf('django.db.models.fields.DateField')())
