...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'gallery_project', 'code',
                      self.gf('django.db.models.fields.TextField')(default=0, max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.code'
        db.delete_column(u'gallery_project', 'code')


    models = {
        u'gallery.project': {
            'Meta': {'object_name': 'Project'},
            'code': ('django.db.models.fields.TextField', [], {'default': '0', 'max_length': '20'}),
